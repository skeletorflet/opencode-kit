...
Seleccione un tema integrado o defina el suyo propio.
...
## [Requisitos del terminal](#requisitos-del-terminal)
...
El tema `system` está diseñado para adaptarse automáticamente a la combinación de colores de su terminal. A diferencia de los temas tradicionales que utilizan colores fijos, el tema *system*:
...
### [Definiciones de colores](#definiciones-de-colores)

La sección `defs` es opcional y le permite definir colores reutilizables a los que se puede hacer referencia en el tema.

---

### [Valores predeterminados del terminal](#valores-predeterminados-del-terminal)
