...
1. Inicias sesión en **[OpenCode Zen](https://opencode.ai/auth)**, agregas tus datos de facturación
   y copias tu API key.
...
Puede que notes *Claude Haiku 3.5* en tu historial de uso. Este es un [modelo de bajo costo](/docs/config/#models) que se usa para generar los títulos de tus sesiones.
...
[Contáctanos](mailto:contact@anoma.ly) si tienes alguna pregunta.
...
### [Límites mensuales](#límites-mensuales)
...
### [Modelos obsoletos](#modelos-obsoletos)
...
### [Acceso a modelos](#acceso-a-modelos)
