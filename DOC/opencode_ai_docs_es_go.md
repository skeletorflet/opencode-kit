...
1. Inicias sesión en **[OpenCode Zen](https://opencode.ai/auth)**, te suscribes a Go y
   copias tu API key.
...
Puedes realizar un seguimiento de tu uso actual en la **[consola](https://opencode.ai/auth)**.

Los límites de uso pueden cambiar a medida que aprendemos del uso inicial y de los comentarios (feedback).

---

### [Uso más allá de los límites](#uso-más-allá-de-los-límites)
