...
### [Deshabilitar complementos](#deshabilitar-complementos)
...
#### [Verifique la configuración global](#verifique-la-configuración-global)
...
#### [Verificar directorios de complementos](#verificar-directorios-de-complementos)
...
### [Borrar el caché](#borrar-el-caché)
...
### [Solucionar problemas de conexión del servidor](#solucionar-problemas-de-conexión-del-servidor)
...
#### [Borrar la URL del servidor predeterminado del escritorio](#borrar-la-url-del-servidor-predeterminado-del-escritorio)
...
#### [Elimina `server.port` / `server.hostname` de tu configuración](#elimina-serverport--serverhostname-de-tu-configuración)

Si su `opencode.json(c)` contiene una sección `server`, elimínela temporalmente y reinicie la aplicación de escritorio.

#### [Verificar variables de entorno](#verificar-variables-de-entorno)
...
### [Linux: Problemas con Wayland/X11](#linux-problemas-con-waylandx11)
...
### [Windows: tiempo de ejecución de WebView2](#windows-tiempo-de-ejecución-de-webview2)
...
### [Windows: Problemas generales de rendimiento](#windows-problemas-generales-de-rendimiento)
...
### [Notificaciones que no se muestran](#notificaciones-que-no-se-muestran)
...
### [Restablecer el almacenamiento de la aplicación de escritorio (último recurso)](#restablecer-el-almacenamiento-de-la-aplicación-de-escritorio-último-recurso)
...
### [OpenCode no se inicia](#opencode-no-se-inicia)
...
### [Error de inicio del proveedor](#error-de-inicio-del-proveedor)
...
### [AI\_APICallError y problemas con el paquete del proveedor](#ai_apicallerror-y-problemas-con-el-paquete-del-proveedor)
...
### [Copiar/pegar no funciona en Linux](#copiarpegar-no-funciona-en-linux)
