...
> **Guide to creating and using Skills in the Opencode Kit**

---

## 📋 Overview

While Opencode's base models are powerful generalists, they don't know your specific project context or your team's standards. Loading every rule or tool into the agent's context window leads to "tool bloat," higher costs, latency, and confusion.

**Opencode Skills** solve this through **Progressive Disclosure**. A Skill is a package of specialized knowledge that remains dormant until needed. This information is only loaded into the agent's context when your specific request matches the skill's description.
...
| ------------- | ------------------------------------- | ------------------------------------ |
| **Workspace** | `<workspace-root>/.opencode/skills/` | Available only in a specific project |
