...
| [react-router-v7](templates/react-router-v7/TEMPLATE.md) | React Router v7 | Modern Remix-style app |
| [hono-cloudflare](templates/hono-cloudflare/TEMPLATE.md) | Hono + Cloudflare Workers | Edge API/full-stack |
| [solidstart-app](templates/solidstart-app/TEMPLATE.md) | SolidStart | Fine-grained reactivity app |
| [angular-app](templates/angular-app/TEMPLATE.md) | Angular 18+ Standalone | Enterprise web app |
| [react-native-app](templates/react-native-app/TEMPLATE.md) | Expo + Zustand | Mobile app |
| [flutter-app](templates/flutter-app/TEMPLATE.md) | Flutter + Riverpod | Cross-platform mobile |
| [electron-desktop](templates/electron-desktop/TEMPLATE.md) | Electron + React | Desktop app |
| [chrome-extension](templates/chrome-extension/TEMPLATE.md) | Chrome MV3 | Browser extension |
| [astro-starlight](templates/astro-starlight/TEMPLATE.md) | Astro + Starlight | Documentation site |
