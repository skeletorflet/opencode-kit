...
- **Priority**: RULES.md rules > intelligent-routing
- If RULES.md specifies explicit routing, follow it
...
**Next Steps**: Integrate this skill into RULES.md TIER 0 rules.
