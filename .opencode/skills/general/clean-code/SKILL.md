...
|-------|--------|---------|
| **frontend-specialist** | UX Audit | `python .opencode/skills/frontend/frontend-design/scripts/ux_audit.py .` |
| **frontend-specialist** | A11y Check | `python .opencode/skills/frontend/frontend-design/scripts/accessibility_checker.py .` |
| **backend-specialist** | API Validator | `python .opencode/skills/backend/api-patterns/scripts/api_validator.py .` |
| **mobile-developer** | Mobile Audit | `python .opencode/skills/mobile/mobile-design/scripts/mobile_audit.py .` |
| **database-architect** | Schema Validate | `python .opencode/skills/backend/database-design/scripts/schema_validator.py .` |
| **security-auditor** | Security Scan | `python .opencode/skills/security/vulnerability-scanner/scripts/security_scan.py .` |
| **test-engineer** | Test Runner | `python .opencode/skills/testing/testing-patterns/scripts/test_runner.py .` |
| **Any agent** | Multi-Lang Lint | `python .opencode/skills/general/lint-and-validate/scripts/lint_runner.py .` |
